...
func GetTaxiTrips(db *sql.DB) {
	...
	var url = "https://data.cityofchicago.org/resource/wrvz-psew.json?$limit=50000"
...
func GetCommunityAreaUnemployment(db *sql.DB) {
	...
	// So, set limit to 100.
	var url = "https://data.cityofchicago.org/resource/iqnk-2tcu.json?$limit=50000"
...
func GetBuildingPermits(db *sql.DB) {
	...
	var url = "https://data.cityofchicago.org/resource/building-permits.json?$limit=50000"
...
func GetCovidDetails(db *sql.DB) {
	...
	var url = "https://data.cityofchicago.org/resource/yhhz-zm2v.json?$limit=50000"
...
func GetCCVIDetails(db *sql.DB) {
	...
	// Set the URL for retrieving CCVI Data
	var url = "https://data.cityofchicago.org/resource/xhc6-88s9.json?$limit=50000"
